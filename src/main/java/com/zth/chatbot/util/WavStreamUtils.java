...
public class WavStreamUtils extends PullAudioInputStreamCallback {
    private final InputStream stream;
    private AudioStreamFormat format;

    public WavStreamUtils(InputStream wavStream) {
        try {
            this.stream = wavStream;
        } catch (Exception ex) {
